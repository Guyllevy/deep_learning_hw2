...
3. deep architectures have deep computation graphs and thus keeping for each node val, grad fields becomes expensive. using those techniques might be crucial to train those networks without running out of memory.<br>
"""
